...
Widget locationSetBox(double currentWidth, double currentHeight,
    double textScale, void Function() onTap,
  ...
  return Container(
    ...
    child: Row(
      ...
      children: [
        Text(
          "${latitude ?? 'Your Location Coordinates'},${longitude ?? ''}",
          style: TextStyle(
  ...
  return ListTile(
    ...
    subtitle: Text(
      ...
      style: TextStyle(
          color: Colors.grey.shade900,
          fontSize:
              responsiveFontSize(13, currentWidth, currentHeight, textScale)),
    ),
  );
}
...
Widget rangeWidget(
  ...
  return Container(
    padding: EdgeInsets.symmetric(
        horizontal: 8 * horizontalPaddingFactor(currentWidth)),
    child: Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(
